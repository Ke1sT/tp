...
public class TypicalPersons {
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withRating("9.5").withEmail("werner@example.com").withAddress("michegan ave").withReferralStatus("yes").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withRating("6.0").withEmail("lydia@example.com").withAddress("little tokyo").withReferralStatus("yes").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withRating("8.5").withEmail("anna@example.com").withAddress("4th street").withReferralStatus("yes").build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withRating("5.0").withEmail("stefan@example.com").withAddress("little india").withReferralStatus("yes").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withRating("4.0").withEmail("hans@example.com").withAddress("chicago ave").withReferralStatus("yes").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withRating(VALID_RATING_AMY).withAddress(VALID_STATUS_AMY)
            .withRoles(VALID_ROLE_FRIEND).withReferralStatus(VALID_REFERRAL_STATUS_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withRating(VALID_RATING_BOB).withAddress(VALID_STATUS_BOB).withRoles(VALID_ROLE_HUSBAND, VALID_ROLE_FRIEND).withReferralStatus(VALID_REFERRAL_STATUS_BOB)
            .build();
